...
# Separate Telegram Bot API monitor. This is intentionally independent from
# the Telethon crawler client/session.
...
TELEGRAM_MONITOR_CHAT_ID = os.getenv("TELCLAW_TELEGRAM_MONITOR_CHAT_ID", "").strip()
TELEGRAM_MONITOR_CHAT_USERNAME = os.getenv("TELCLAW_TELEGRAM_MONITOR_CHAT_USERNAME", "").strip()
